...
INSERT INTO owners (first_name, last_name, address, city, telephone) SELECT 'Edward', 'Coleman', '108 Oregona St.', 'Ostin', '6085552177' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=11);
